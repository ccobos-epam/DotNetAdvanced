...
public class CreateEndpoint_V01 : FE.Endpoint<CreateCategoryRequest, CreateCategoryResponse>
{
    ...
    public override async Task HandleAsync(CreateCategoryRequest request,  CancellationToken cancellationToken)
    {
        ...
        await Send.CreatedAtAsync<Get.GetEndpoint_V01>(response.Id, response, FE.Http.GET, null, false, cancellationToken);
    }
}
